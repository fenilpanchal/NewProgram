...
public class RepositoryTest {
    ...
    public void TestFindByUsername(){
        Employee2 employee = new Employee2(null,"John","john@123","john@gmail.com",Role.ADMIN);
        employee2Repository.findByUsername(employee.getUsername());

        Assertions.assertNotNull(employee);
        Assertions.assertEquals("john@gmail.com",employee.getEmail());
        Assertions.assertEquals(Role.ADMIN,employee.getRole());
        Assertions.assertEquals("john@123",employee.getPassword());
